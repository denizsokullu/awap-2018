...
class Player(BasePlayer):
    ...
    def __init__(self, p_id):
        super().__init__(self, p_id)  #Initializes the super class. Do not modify!
    ...
    def init_turn(self, board, nodes, max_units):
        super().init_turn(self, board, nodes, max_units)       #Initializes turn-level state variables
    ...
    def player_place_units(self):
        ...
        return super().dict_moves #Returns moves built up over the phase. Do not modify!
